...
import com.github.abhishek5074.newsapp.databinding.FragmentHomeBinding
...
class HomeFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        NewsApiService.newsApi.getCategoryNews(Credentials.API_KEY, "in", "general",100)
            .enqueue(object :
                Callback<Model> {
        ...
        binding.homeRecyclerView.layoutManager = LinearLayoutManager(this.activity)
        return binding.root
    }
